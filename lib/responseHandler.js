module.exports = {
  validMessage({
    Discord, client, message, command, color = '#6F39B0', author: { name = '', avatar = client.user.avatarURL() }, title = '', description = '', thumbnail = '', fields = [],
  }) {
  ...
  syntaxErrorMessage(Discord, message, command, { prefix = '', suffix = '' }) {
